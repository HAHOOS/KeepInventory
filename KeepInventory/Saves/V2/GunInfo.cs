...
namespace KeepInventory.Saves.V2
{
    ...
    public class GunInfo()
    {
        ...
        /// <summary>
        /// Parses <see cref="V1.GunInfo"/> to <see cref="V2.GunInfo"/>
        /// </summary>
        /// <param name="gunInfoV1">The old <see cref="GunInfo"/></param>
        /// <returns>A parsed <see cref="GunInfo"/> from a <see cref="V1.GunInfo"/></returns>
        /// <returns>A parsed <see cref="GunInfo"/> from a <see cref="V1.GunInfo"/></returns>
